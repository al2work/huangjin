## 1. 产品概述
实时黄金价格展示网站，专为中文用户设计。通过域名 huangjin.xin 为投资者和消费者提供准确的黄金价格信息，数据来源于上海黄金交易所(SGE)官方数据，帮助用户及时了解市场动态，做出明智的投资决策。
...
| 关于页面 | 网站介绍 | 说明网站功能、目标和数据来源 |
| 关于页面 | 数据来源 | 详细说明上海黄金交易所数据获取方式 |
| 关于页面 | 联系方式 | 提供网站运营方联系信息 |

## 3. 核心流程
用户访问网站的主要操作流程：
1. 用户访问首页 → 查看实时黄金价格 → 查看24小时趋势图 → 了解市场概况
2. 用户点击详情 → 查看详细价格信息 → 分析历史趋势 → 阅读技术分析
3. 用户浏览关于页面 → 了解数据来源 → 查看联系方式
